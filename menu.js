...
function Stats() {
	...
	Stats.prototype.render = function() {
		...
		context.fillStyle = "rgba(255,255,255, " + alph + ")";
	   	context.font = "50px Tahoma";
	   	context.fillText("Health: " + this.userHP + "/" + this.userMaxHP, 100, dY);
	   	context.fillText("Attack: " + this.userAttack, 100, dY+50);
	   	context.fillText("Defense: " + this.userDefense, 100, dY+100);
